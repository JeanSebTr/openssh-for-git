...
initialize_server_options(ServerOptions *options)
{
	...
	options->authorized_keys_socket = NULL;
...
static struct {
	...
	{ "authorizedkeyssocket", sAuthorizedKeysSocket, SSHCFG_GLOBAL },
    ...
    const char *host, const char *address)
{
 ...
 parse_flag:
	...
	case sAuthorizedKeysSocket:
		charptr = &options->authorized_keys_socket;
		goto parse_filename;
...
dump_config(ServerOptions *o)
{
	...
	dump_cfg_string(sAuthorizedKeysSocket, o->authorized_keys_socket);
